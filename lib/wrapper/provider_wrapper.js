 ...
 * @param {Object} [filefog_options={transform:true, include_raw:true}] - options that enable tranformations, raw data, etc.
...
module.exports = function(name, classes, config,filefog_options){
     ...
     * @param {Object} config
     * @param {Object} [filefog_options={transform:true, include_raw:true}]
     * @return 
     */
