var BoxProvider = require('./box/box-provider.js').provider
    , DropboxProvider = require('./dropbox/dropbox-provider.js').provider
    , GoogleProvider = require('./google_drive/google-drive-provider.js').provider
    , SkydriveProvider = require('./skydrive/skydrive-provider.js').provider
...
function generateProviderOptions(service,provider_options){
    ...
    provider_options = extend(true, provider_options, config[service]);
