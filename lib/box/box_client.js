    ...
    this.CreateFile = function (fileName, parentIdentifier, content_buffer, options) {
        ...
        return getClient()
            ...
            .then(function (response) {
                ...
                if (raw_response)
                    return response;
                return require('./box_transform.js').parseFileInformation(response.entries[0]);
            })
    }
    ...
    this.DeleteFile = function (identifier, options) {
        ...
        return getClient()
            ...
            .then(function (response) {
                ...
                if (raw_response)
                    return response;
                return require('./box_transform.js').parseDeletion(response);
            })
    }
    ...
    this.GetFileInformation = function (identifier, options) {
        ...
        return getClient()
            ...
            .then(function (response) {
                ...
                if (raw_response)
                    return response;
                return require('./box_transform.js').parseFileInformation(response);
            })
    }
    ...
    this.CreateFolder = function (folderName, parentIdentifier, options) {
        ...
        return getClient()
            ...
            .then(function (response) {
                ...
                if (raw_response)
                    return response;
                return require('./box_transform.js').parseFolderInformation(response);
            })
    }
